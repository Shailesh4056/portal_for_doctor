...
<form action="cov45do.php" method="post">
                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="pt-3 pb-4">
                                <div class="input-group">
                                    <input type="text" id="" name="pincode" class="form-control"  placeholder="Search By Pin Code">
                                    <div class="input-group-append">
                                        <button type="submit" name="search" class="btn waves-effect waves-light btn-custom"><i class="fa fa-search mr-1"></i> Search</button></a>
                                    </div>
                                </div>
