...
$con = mysqli_connect('localhost','root');
 ...
 if(isset($_POST['search']))
 {
	...
	$date=date('y-m-d');
$display= "SELECT `id`, `age`, `dose2`, `qwt`, `date`, `pin`, `address` FROM `18+dos2` WHERE pin='$pincode' and date >='$date'";
...
?>
  <tr>
			  ...
			  <td>
			  <?php if($sult ['qwt'] !=0){ ?>
			  <button type="button" class="btn btn-info"  id="button"><a href="18d2form.php?id=<?php echo $sult['id']; ?>&sid=<?=$_POST['id'];?>" class="text-white">Book Now
				     </a></button>
