...
<body>
<p style="border:5px dashed #0080ff; font-size:50px; color:Red;">&nbsp&nbsp&nbsp <img src="/phot/fail2.png" height="40px" width="60px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Your Booking is Failed</p>
