...
$User_Id=$_SESSION['User_Id'];
  ...
  $p="SELECT * FROM `18+dos1` WHERE adhar='$adhar'";
...
$qt="INSERT INTO `18+dos1`(`date`, `dose`, `pincode`, `address`, `name`, `adhar`, `dob`, `Gender`, `Contact`, `E-mail`, `slot`, `code`, `status`, `User_Id`) VALUES ('$da','$do','$pin','$loc','$fna', '$adhar','$dob','$ge','$Contact','$ma','$ty' ,'$code', '$status', '$User_Id')";
 ...
 $date=date('y-m-d');
  ...
  { 
	...
	$sub="Covid-19 Vaccine Booking";
   	$body="$fna: You have been successfully registered for vaccination with fist dose. You have to visit on $da, $ty at $pin-$loc.\n  With warm regard.\n Stay Home,Stay Safe! ";
