...
<div class="container">
	...
	<div>&nbsp;</div>
	<form autocomplete="off" method="post" action="cccb.php" id="frmPinCode" style="text-align:center;">
		<div class="search">
		<div>
		...
		<div>
           ...
           <input type="submit" name="search" class="sub" title="Invalid input" value="search">
           </div>
		</div>
	</form>
</div>
