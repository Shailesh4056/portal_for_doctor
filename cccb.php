...
$display= "SELECT `id`, `Hospital`, `Doctor`, `Pincode`, `Address`, `email`, `Phone`, `image`, `type` FROM `hospitals` WHERE pincode='$pincode'";
                       ...
                       <center> <h4 class="font-weight-bold mt-0 mb-4">Physical Appointment Booking Details</h4></center>
                        <div class="bg-white card mb-4 order-list shadow-sm">
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    <a href="#">
									<?php echo '<img class="mr-4" src = "data:image;base64,'.base64_encode($sult['image']).'"alt="image" style = "alt="Admin" class="rounded-circle"">'; ?>
                                    </a>
