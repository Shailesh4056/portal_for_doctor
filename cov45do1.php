...
$qt="INSERT INTO `18+dos1`(`age`, `date`, `dose`, `pincode`, `address`, `name`, `adhar`, `dob`, `Gender`, `Contact`, `E-mail`, `slot`, `code`, `status`, `User_Id`) VALUES ('$ag', '$da','$do','$pin','$loc','$fna', '$adhar','$dob','$ge','$Contact','$ma','$ty' ,'$code', '$status', '$User_Id')";
