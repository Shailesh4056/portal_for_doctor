...
<option value="RT-PCR Test(Results:4 to 5 hours,Price:500)">RT-PCR Test(Results:4 to 5 hours,Price:500)</option>
<option value="TrueNat & CDNAAT Test(Results:60 minutes,Price:1000)">TrueNat & CDNAAT Test(Results:60 minutes,Price:1000)</option>
<option value="Rapid Point-Of-Care Antigen Detection Test(Results:15 minutes,Price:1500)">Rapid Point-Of-Care Antigen Detection Test(Results:15 minutes,Price:1500)</option>
</select>
...
<h3>   </h3>
<input type="radio" name="gender" value="Mail"/>Male <input type="radio" name="gender" value="Femail">Female
