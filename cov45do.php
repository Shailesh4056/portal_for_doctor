...
$con = mysqli_connect('localhost','root');
 ...
 if(isset($_POST['search']))
 {
	...
	$date=date('y-m-d');
$display= "SELECT `id`, `age`, `dose1`, `qwt`, `date`, `pin`, `address` FROM `45dose1` WHERE pin='$pincode' and date >='$date'";
...
?>
  <tr>
			  ...
			  <td>
			  <?php if($sult ['qwt'] !=0){ ?>
			  <button type="button" class="btn btn-info"  id="button"><a href="dose45.php?id=<?php echo $sult['id']; ?>" class="text-white">Book Now
				     </a></button>
