...
<input type="hidden" name="age" id="date" value="<?php echo $sult ['age'];?>" readonly="readonly">
<input type="hidden" name="date" id="date" value="<?php echo $sult ['date'];?>" readonly="readonly">
<input type="hidden" name="dose" id="dose" value="<?php echo $sult ['dose2'];?>" readonly="readonly">
...
?>
<p>Name</p>
<input type="text" id="name" name="name" placeholder="First Name" readonly="readonly" value="<?php echo $sult ['name'];?>">

<p>Addaar number</p>
<input type="text" id="adhar" name="adhar" placeholder="Adhar number" readonly="readonly" value="<?php echo $sult ['adhar'];?>" required>
<p>Date Of Borth</p>
<input type="date" id="dob" name="dob" placeholder="Enter testing date" required>
<p id="err15" style="color:Red;"></p>
<p>Gender</p>
 <input type="text" name="gen" id="gen" readonly="readonly" value="<?php echo $sult ['Gender'];?>">
<p>Contact no</p>
<input type="text" name="Contact" id="cont" placeholder="Enter a contact no" value="<?php echo $sult ['Contact'];?>" required>
<p id="err" style="color:Red;"></p>
<p>E-mail</p>
<input type="mail" name="mail" id="mail" placeholder="Enter your mail" readonly="readonly" value="<?php echo $sult ['E-mail'];?>" required>
...
function myFunction() {
  ...
  if (dob.value.length > 15/12/2001)
  { 
  document.getElementById("err15").innerHTML = "*your age is not a valid";
  return false;
  }
  if(mai.indexOf('@') <= 0)
  {
