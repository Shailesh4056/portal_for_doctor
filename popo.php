...
if(isset($_POST['submit'])){
  ...
  $p="SELECT * FROM `45dose2` WHERE date='$date' & address='$Address' & pin='$pincode'";
...
{
	$n="INSERT INTO `45dose2`(`age`, `dose2`, `qwt`, `date`, `pin`, `address`) VALUES ('$age','$dose','$doseqwt','$date','$pincode','$Address')";
