...
$display="SELECT * FROM appointment WHERE User_Id = '$myid'";
            ...
            <div class="osahan-account-page-right shadow-sm bg-white">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane  fade  active show" id="orders" role="tabpanel" aria-labelledby="orders-tab">
                       <center> <h4 class="font-weight-bold mt-0 mb-4">virtual Appointment Booking Details</h4></center>
                            ...
                            <div class="gold-members p-4">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <a href="#">
                                            <span class="float-right text-info">Appointment date, <?php echo $sult ['date'];?> ,<?php echo $sult ['timeslot'];?><i class="icofont-check-circled text-success"></i></span>
                                        </a>
                                        <h6 class="mb-2">
										<p class="mb-1">ID:
                                            <a href="#" class="text-black"><?php echo $sult['id'];?></a></p>
										                                        ...
										                                        <h6 class="mb-2">
										<p class="mb-1">Name:
                                            <a href="#" class="text-black"><?php echo $sult['fname'];?></a></p>
                                        </h6>
										                                        <h6 class="mb-2">
										<p class="mb-1">Appointment Date:
                                            <a href="#" class="text-black"><?php echo $sult ['date'];?></a></p>
                                        </h6>
										<p class="mb-1">Slot:
                                            <a href="#" class="text-black"><?php echo $sult ['timeslot'];?></a></p>
                                        </h6>
										     <p class="mb-1">Contact_No:
                                            <a href="#" class="text-black"><?php echo $sult ['cont'];?></a></p>
                                        </h6>
							              <p class="mb-1">Gender:
                                            <a href="#" class="text-black"><?php echo $sult ['gen'];?></a></p>
                                        </h6>
							       
							           <p class="mb-1">Contact_No:
                                            <a href="#" class="text-black"><?php echo $sult ['mail'];?></a></p>
											
                                        </h6>
																	           <p class="mb-1">CUST_ID:
                                            <a href="#" class="text-green" style="color: #14DE69";><?php echo $sult ['CUST_ID'];?></a></p>
											</h6>
													<p class="mb-1">TXN_AMOUNT:
                                            <a href="#" class="text-green" style="color: red"><?php echo $sult ['TXN_AMOUNT'];?></a></p>
											<p class="mb-1">ORDER_ID:
                                            <a href="#" class="text-green"><?php echo $sult ['ORDER_ID'];?></a></p>
											</h6>
										<h6>
										</h6>
										<h6>
